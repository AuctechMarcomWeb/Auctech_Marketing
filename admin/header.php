                ...
                <ul class="side-menu metismenu">
                    ...
                    <li class="mt-3">
                        <a href="javascript:;"><i class="sidebar-item-icon"><img width="30" height="30"
                                    src="https://img.icons8.com/ios-filled/50/FFFFFF/old-shop.png" alt="old-shop" /></i>
                    ...
                    <li>
                        <a class="" href="job_list"><i class="sidebar-item-icon"><img width="30" height="30"
                                    src="https://img.icons8.com/ios-glyphs/30/FFFFFF/new-job.png" alt="new-job" /></i>
                    ...
                    <li class="mt-2">
                        <a href="javascript:;"><i class="sidebar-item-icon"><img width="30" height="30"
                                    src="https://img.icons8.com/ios-filled/50/FFFFFF/event-accepted.png" /></i>
                            <span class="nav-label"> Appointment Page</span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="booked_list"> Booked Appointment </a>
                            </li>
                            <li>
                                <a href="service_list"> Contact Query List</a>
                            </li>
                        </ul>
                    </li>
