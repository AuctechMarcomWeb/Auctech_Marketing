            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="vl-footer-widget-black6 vl-footer1-logo-area mr-50 mb-50">
                        ...
                        <div class="vl-footer-social6 text-start mt-20">
                            ...
                            <a href="https://www.linkedin.com/company/auctech-marketing-communication-pvt-ltd/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="vl-footer-widget-black6 mb-50 ml-70 md:ml-0 sm:ml-0">
                        ...
                        <div class="vl-footer-list">
                            <ul>
                                  <li><a href="wealthbuilder-crm.php">Wealth Builder CRM</a></li>
...
<div class="float-sm">
    <div class="fl-fl float-fb">
        <img class=" fa-facebook" src="https://img.icons8.com/ios-filled/ffffff/facebook-f.png" alt="facebook-f">
    ...
    <div class="fl-fl float-rs">
        <img class=" fa-linkedin" src="https://img.icons8.com/ios-glyphs/ffffff/linkedin-2--v1.png"
            alt="linkedin-2--v1">
        <a href="https://www.linkedin.com/company/auctech-marketing-communication-pvt-ltd/" target="_blank">Follow us !</a>
    </div>
    <div class="fl-fl float-ig">
        <img class="fa-instagram"
            src="https://img.icons8.com/external-tal-revivo-bold-tal-revivo/ffffff/external-instagram-photo-and-video-sharing-social-networking-service-owned-by-facebook-logo-bold-tal-revivo.png"
